...
<div class="max-w-2xl mx-auto">
    {{-- Header Section --}}
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Edit Jadwal Kegiatan</h1>
        <p class="text-sm text-gray-500">
            Memperbarui rincian itinerary untuk paket: 
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="bg-red-50 border-l-4 border-red-500 p-4 m-6 mb-0 rounded-r">
            <div class="flex">
                ...
                <div class="ml-3">
                    <h3 class="text-sm leading-5 font-medium text-red-800">Gagal memperbarui data:</h3>
        ...
        {{-- Form Start --}}
        <form action="{{ route('admin.jadwal.update', $jadwal->id_kegiatan) }}" method="POST" class="p-8">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-500">
                        Pastikan hari berada dalam durasi paket (Maksimal: {{ $paket->durasi_paket }} hari).
                    </p>
                </div>
                ...
                <div>
                    ...
                    <textarea name="kegiatan" id="kegiatan" rows="3" 
                        class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 transition shadow-sm py-2.5 px-4" 
                        required>{{ old('kegiatan', $jadwal->kegiatan) }}</textarea>
                </div>
            </div>
