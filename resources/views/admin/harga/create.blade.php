...
<div class="max-w-2xl mx-auto">
    {{-- Header Section --}}
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Tambah Opsi Harga</h1>
        <p class="text-sm text-gray-500">
            Menentukan harga paket berdasarkan jumlah peserta untuk: 
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        {{-- Validasi Error (Opsional, untuk jaga-jaga) --}}
        @if ($errors->any())
        ...
        {{-- Form Start --}}
        <form action="{{ route('admin.harga.store', $paket->id_paket) }}" method="POST" class="p-8">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-500">Masukkan angka jumlah orang (misal: 2, 5, 10).</p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-500">Harga yang dibebankan untuk satu orang.</p>
                </div>
            </div>

            {{-- Action Buttons --}}
            <div class="mt-8 pt-6 border-t border-gray-100 flex items-center justify-end gap-3">
                <a href="{{ route('admin.harga.index', $paket->id_paket) }}" class="px-5 py-2.5 rounded-lg border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 text-sm font-medium transition shadow-sm">
                    Batal
                </a>
