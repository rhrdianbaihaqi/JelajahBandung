...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-500">
            Memperbarui data fasilitas untuk paket: 
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        {{-- Form Start --}}
        <form action="{{ route('admin.fasilitas.update', $fasilitas->id_fasilitas) }}" method="POST" class="p-8">
            @csrf
            @method('PUT')
                ...
                <div>
                    ...
                    <div class="relative">
                        <select name="included" id="included" 
                            ...
                            <option value="1" {{ $fasilitas->included ? 'selected' : '' }}>Termasuk (Included)</option>
                            <option value="0" {{ !$fasilitas->included ? 'selected' : '' }}>Tidak Termasuk (Excluded)</option>
                        </select>
                    ...
                    <p class="mt-2 text-xs text-gray-500">
                        Ubah status jika kebijakan biaya untuk fasilitas ini berubah.
                    </p>
                </div>
            </div>
