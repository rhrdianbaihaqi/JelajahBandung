  ...
  <nav class="bg-gradient-to-b from-white/95 to-white/80 shadow fixed w-full z-50 transition-all duration-300" x-data="{ isOpen: false, scrolled: false }" @scroll.window="scrolled = (window.pageYOffset > 20)" :class="{ 'bg-white/95 shadow-md': scrolled, 'bg-white/80': !scrolled }">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <!-- Desktop Menu -->
        <div class="hidden md:flex space-x-8 items-center">
          ...
          <a href="#visi-misi" class="text-gray-700 hover:text-blue-600 font-medium transition-colors duration-200 relative group">
            Visi Misi
            <span class="absolute bottom-0 left-0 w-full h-0.5 bg-blue-600 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-200"></span>
          </a>
          <a href="#produk" class="text-gray-700 hover:text-blue-600 font-medium transition-colors duration-200 relative group">
            Produk Kami
            <span class="absolute bottom-0 left-0 w-full h-0.5 bg-blue-600 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-200"></span>
          </a>
    ...
    <div x-show="isOpen" 
      ...
      <div class="flex flex-col px-4 pt-2 pb-6 space-y-2">
        ...
        <a href="#visi-misi" @click="isOpen = false" class="block px-4 py-3 text-base font-medium text-gray-700 hover:text-blue-600 hover:bg-blue-50/50 rounded-lg transition-all duration-200 flex items-center space-x-2">
        ...
        <a href="#produk" @click="isOpen = false" class="block px-4 py-3 text-base font-medium text-gray-700 hover:text-blue-600 hover:bg-blue-50/50 rounded-lg transition-all duration-200 flex items-center space-x-2">
