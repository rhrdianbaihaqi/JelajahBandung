...
<body class="bg-fixed bg-center bg-cover" style="background-image: url('{{ asset('image/bandung.jpg') }}');">
  ...
  <nav class="bg-gradient-to-b from-white/95 to-white/80 shadow fixed w-full z-50">
    <div class="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
      <!-- Logo dan Judul -->
      <a href="/tentang" class="flex items-center space-x-2">
      ...
      <ul class="flex space-x-6">
        ...
        <li><a href="#paket-wisata" class="hover:text-blue-600 font-semibold">Paket Wisata</a></li>
        <li><a href="#testimoni" class="hover:text-blue-600 font-semibold">Testimoni</a></li>
